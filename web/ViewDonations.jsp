    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <div id="content-wrapper" class="d-flex flex-column">
                ...
                <div id="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card-header py-3">
                            <h2 class="m-0 font-weight-bold text-primary">Donation Details</h2>
                        </div>
                        <!-- DataTales Example -->
                ...
                //                                String sql ="SELECT * FROM Devotees1,Devotees2,Charity where Devotees1.SRNO = Devotees2.SRNO and Devotees1.SRNO = Charity.SRNO";

                                                String sql = "SELECT * FROM Devotees1,Charity where Devotees1.SRNO = Charity.SRNO";
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td><%=resultSet.getString("Date_of_Donation")%></td>
