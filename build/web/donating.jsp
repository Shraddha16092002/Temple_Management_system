...
//    out.println(cdate);
    ...
    String donamt = request.getParameter("donamt");
    String transid = request.getParameter("transid");

    String query1 = "insert into devotees1(aadhar,name,email,city,state) values(?,?,?,?,?)";
    String query2 = "insert into charity(date_of_donation,amount,trans_id,srno) values(?,?,?,?)";
...
//    numval=rs.getInt(1);
        ...
        ps2.setString(2, donamt);
        ps2.setString(3, transid);
        ps2.setString(4, num1);
...
//int j=ps.executeUpdate();
    ...
    session.setAttribute("val", donamt);
                ...
                <div class="col-rt-12">
                    <div class="Scriptcontent">
                        <div id='card' class="animated fadeIn">
                            ...
                            <div id='lower-side'>
                                <p id='message'>
                                    Congratulations, your donation is successful!
                                </p>
                                <a href="DonationReceipt.jsp" id="contBtn">Download Receipt</a>
                            </div>
                        </div>		   
                    </div>
                </div>
